...
def main(subdirs, seeds, class_num, max_batch_size, device=torch.device('cuda'), **sampler_kwargs):
    """Generate random images using the techniques described in the paper
    "Elucidating the Design Space of Diffusion-Based Generative Models".
    ...
    outdir = r"D:\cjh\Adversarial_Robustness\datasets\CIFAR10_EN"
    ...
    with open(r"D:\cjh\Adversarial_Robustness\third_party\DM-Improves-AT\edm-cifar10-32x32-cond-vp.pkl", 'rb') as f:
        net = pickle.load(f)['ema'].to(device)
